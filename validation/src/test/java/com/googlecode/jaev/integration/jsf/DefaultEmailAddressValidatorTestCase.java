...
public final class DefaultEmailAddressValidatorTestCase {
	...
	private void test(String mailAddress, String expectedMessage) {
		final FacesContext facesContext = this.context.mock(FacesContext.class);
		final UIViewRoot viewRoot = this.context.mock(UIViewRoot.class);
		final UIComponent component = this.context.mock(UIComponent.class);
