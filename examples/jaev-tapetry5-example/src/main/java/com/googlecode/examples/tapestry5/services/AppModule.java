...
public class AppModule
{
	...
	{
		binder.bind(Validator.class, new ServiceBuilder<Validator>()
		{

			@Override
			public Validator buildService(ServiceResources resources)
			{
				return Validation.basic().fromAddress(defaultFromAddress())
					.buildFactory().getValidator();

			}
		});

		binder.bind(ResultTranslator.class, StandardMappingTransator.class);
